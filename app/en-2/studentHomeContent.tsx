...
import { cCV, homeclasses, secondsToHrs } from "../[lang]/content";
import { motion } from "framer-motion";
import Link from "next/link";
import { StudentHome } from "../[lang]/studentHomeContent";
      ...
      {student.currentMeet ? (
        <section className="bg-white rounded-lg flex flex-col gap-4 p-8 text-center">
          ...
          <div className="flex flex-row gap-4 justify-center">
            ...
            <ADE domain copy={"/en/meetings/meeting/" + student.currentMeet.id} />
          </div>
        </section>
      ) : undefined}
      <section>
