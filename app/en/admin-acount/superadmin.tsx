    ...
    <section className={classes["section"] + "p-4 mb-2"}>
      <div>
        <Checker
          type="switch"
          id="appear"
          label="Appear to admin and teachers"
          checked={data.appear}
        ...
        <Checker
          type="switch"
          id="appear"
          label="Allow you to see users of the opposite sex"
        ...
        {Number.isNaN(+data.hour_price) && (
          <p className="text-red-500">not a number</p>
        )}
        {+data.hour_price < 0.1 && (
          <p className="text-red-500">It should not be less than 0.1.</p>
        )}
      </div>
