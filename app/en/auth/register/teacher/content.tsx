...
const Content = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (response.status === 201) {
        setMessage(["Teacher account has created"]);
        setLoading(false);
  ...
  const submit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!preferedTime) {
      alive = false;
      setMessage((m) => {
        return [...m, "You must specify your favourite time for working."];
      });
    }
      ...
      <div className="md:p-12 p-4">
        ...
        >
          ...
          <h2 className="text-xl">
            Preferred working time (according to Egypt time)
          </h2>
          <div className="flex justify-evenly md:gap-4 flex-wrap">
            ...
            >
              ...
              <div>
                <p className="text-center md:text-xl text-md mb-4">Morning</p>
                <p className="md:text-base text-sm">From dawn to noon</p>
              </div>
            </div>
            <div
              className={
            ...
            >
              ...
              <div>
                <p className="text-center md:text-xl text-md mb-4">Afternoon</p>
                <p className="md:text-base text-sm">From noon to dinner</p>
              </div>
            </div>
            <div
              className={
            ...
            >
              ...
              <div>
                <p className="text-center md:text-xl text-md mb-4">evenning</p>
                <p className="md:text-base text-sm">From dinner to dawn</p>
              </div>
            </div>
          </div>
          <textarea
