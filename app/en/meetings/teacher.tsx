                  ...
                  {meetings
                    ...
                    .map(({ delay, starts, student }, i) => {
                      ...
                      return (
                        ...
                        >
                          <p className="text-lg mb-2">Student {student}</p>
                          <p className="mb-2">
                            Starts at {convertedStart}{" "}
                          ...
                          <p className="pb-2">Ends at {convertedSum} </p>
                        </div>
                      );
                    })}
                </div>
      ...
      <div className="p-4">
        <p className="p-6 bg-white rounded-lg text-gray-600">
          {response.succes
            ...
            : response.error === 3
            ? "You have not been approved yet so there are no meetings."
