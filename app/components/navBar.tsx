...
const adminOptionList: { ar: option[]; en: option[] } = {
  ar: [
    {
      name: "المعلمين",
...
const superAdminOptionList: { ar: option[]; en: option[] } = {
  ar: [
    ...adminOptionList.ar,
    {
      name: "المشرفين",
...
const unlogedOptionList: { ar: option[]; en: option[] } = {
  ar: [
    {
      name: "تسجيل الدخول",
...
const studentOptionList: { ar: option[]; en: option[] } = {
  ar: [
    {
      name: "التقارير",
      ...
      >
        <div className="flex lg:flex-1 gap-4 items-center">
          ...
          <span
            ...
            onClick={() => {
              ...
              document.cookie = `userLang=${otherLang}; expires=${DateTime.now()
                .plus({ years: 1 })
                .toISO()}; path=/; SameSite=Lax; Secure`;
              router.push(pathname.replace(`/${lang}`, `/${otherLang}`));
            }}
          >
        ...
        <PopoverGroup className="hidden lg:flex lg:gap-x-12">
          <Popover className="relative">
            ...
            >
              <PopoverPanel className="absolute -start-8 top-full z-10 mt-3 w-screen max-w-md overflow-hidden rounded-3xl bg-white shadow-lg ring-1 ring-gray-900/5">
                <div className="p-4">
                  {list[lang].map((item) => (
                    <Link
                      href={
