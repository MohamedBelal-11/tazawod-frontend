...
export const metadata: Metadata = {
  title: "أكادمية تزود",
  description:
    "تعليم الأصول هي منصة تعليمية إسلامية شاملة توفر دروسًا مباشرة عبر الإنترنت لتحفيظ وتلاوة وتجويد القرآن الكريم، بالإضافة إلى تعليم الفقه الإسلامي، السنة النبوية، والسيرة النبوية.",
  keywords:
